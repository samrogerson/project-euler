/*
In a 20x20 grid below, four numbers along a diagonal line  have a product of
 26 * 63 * 78 * 14 = 1788696.
...
func makegrid() {
    ...
    grid[14] = []int{4, 52, 8, 83, 97, 35, 99, 16, 7, 97, 57, 32, 16, 26, 26, 79, 33, 27, 98, 66}
    grid[15] = []int{88, 36, 68, 87, 57, 62, 20, 72, 3, 46, 33, 67, 46, 55, 12, 32, 63, 93, 53, 69}
    grid[16] = []int{4, 42, 16, 73, 38, 25, 39, 11, 24, 94, 72, 18, 8, 46, 29, 32, 40, 62, 76, 36}
    ...
    grid[19] = []int{1, 70, 54, 71, 83, 51, 54, 69, 16, 92, 33, 48, 61, 43, 52, 1, 89, 19, 67, 48}
}

func product(nums []int) (prod int64) {
    prod = 1
